    ...
    public function run()
    {
        ...
        DB::table('menus')->insert(
            ...
            (
                ...
                array('parent_id' => 2,'action'=> 3,'name'  => 'Add', 'menu_url'  => 'add-role.create', 'module_id'  => '1', 'status'  => '1','module_group_id'=>'1.3'),
                array('parent_id' => 2,'action'=> 3,'name'  => 'Edit', 'menu_url'  => 'add-role.edit', 'module_id'  => '1', 'status'  => '1','module_group_id'=>'1.4'),
                ...
                array('parent_id' => 7,'action'=> 3,'name'  => 'Add', 'menu_url'  => 'add-role.create', 'module_id'  => '1', 'status'  => '1','module_group_id'=>'2.1'),
                array('parent_id' => 7,'action'=> 3,'name'  => 'Edit', 'menu_url'  => 'add-role.edit', 'module_id'  => '1', 'status'  => '1','module_group_id'=>'2.3'),
